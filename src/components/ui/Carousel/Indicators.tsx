    ...
    >
      {scrollSnaps.map((number, index) => (
        <DotButton
          ...
          className={cn("inline-flex size-3 rounded-full border-2 border-primary-300 dark:border-primary-800", `${index === selectedIndex && 'border-primary-900 dark:border-primary-100'
            }`, dotButtonStyle)}
        />
      ))}
    </div>
